...
class Category
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :books`.
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_ancestry?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_ancestry?(from: T.unsafe(nil), to: T.unsafe(nil)); end
