...
module Ancestry::InstanceMethods
  ...
  # @return [Boolean]
  #
  # source://ancestry//lib/ancestry/instance_methods.rb#97
  def ancestors?; end
  ...
  # @return [Boolean]
  #
  # source://ancestry//lib/ancestry/instance_methods.rb#226
  def childless?; end
  ...
  # @return [Boolean]
  #
  # source://ancestry//lib/ancestry/instance_methods.rb#221
  def children?; end
  ...
  # @return [Boolean]
  #
  # source://ancestry//lib/ancestry/instance_methods.rb#251
  def only_child?; end
  ...
  # @return [Boolean]
  #
  # source://ancestry//lib/ancestry/instance_methods.rb#171
  def parent_id?; end
  ...
  # @return [Boolean]
  #
  # source://ancestry//lib/ancestry/instance_methods.rb#202
  def root?; end
  ...
  # @return [Boolean]
  #
  # source://ancestry//lib/ancestry/instance_methods.rb#246
  def siblings?; end
...
module Ancestry::MaterializedPath::InstanceMethods
  ...
  # @return [Boolean]
  #
  # source://ancestry//lib/ancestry/materialized_path.rb#117
  def has_parent?; end
