...
class Net::HTTPGenericRequest
  ...
  # @return [Boolean]
  #
  # source://oauth//lib/oauth/client/net_http.rb#117
  def oauth_body_hash_required?(options); end

  # source://oauth//lib/oauth/client/net_http.rb#73
  ...
  # base string.
  #
  # source://oauth//lib/oauth/client/net_http.rb#132
  def set_oauth_body; end

  # source://oauth//lib/oauth/client/net_http.rb#121
  def set_oauth_header; end

  # source://oauth//lib/oauth/client/net_http.rb#140
...
class OAuth::Client::Helper
  ...
  # source://oauth//lib/oauth/client/helper.rb#77
  def amend_user_agent_header(headers); end

  # source://oauth//lib/oauth/client/helper.rb#73
  def hash_body; end

  # source://oauth//lib/oauth/client/helper.rb#87
  def header; end
...
class OAuth::Consumer
  ...
  #
  # source://oauth//lib/oauth/consumer.rb#106
  def initialize(consumer_key, consumer_secret, options = T.unsafe(nil)); end

  # source://oauth//lib/oauth/consumer.rb#355
  def access_token_path; end

  # source://oauth//lib/oauth/consumer.rb#384
  def access_token_url; end

  # @return [Boolean]
  #
  # source://oauth//lib/oauth/consumer.rb#388
  def access_token_url?; end

  # source://oauth//lib/oauth/consumer.rb#347
  def authenticate_path; end

  # source://oauth//lib/oauth/consumer.rb#368
  def authenticate_url; end

  # @return [Boolean]
  #
  # source://oauth//lib/oauth/consumer.rb#372
  def authenticate_url?; end

  # source://oauth//lib/oauth/consumer.rb#351
  def authorize_path; end

  # source://oauth//lib/oauth/consumer.rb#376
  def authorize_url; end

  # @return [Boolean]
  #
  # source://oauth//lib/oauth/consumer.rb#380
  def authorize_url?; end

  # Creates and signs an http request.
  # It's recommended to use the Token classes to set this up correctly
  #
  # source://oauth//lib/oauth/consumer.rb#274
  def create_signed_request(http_method, path, token = T.unsafe(nil), request_options = T.unsafe(nil), *arguments); end

  # source://oauth//lib/oauth/consumer.rb#120
  ...
  #
  # source://oauth//lib/oauth/consumer.rb#160
  ...
  #
  # source://oauth//lib/oauth/consumer.rb#81
  def http=(_arg0); end

  # The default http method
  #
  # source://oauth//lib/oauth/consumer.rb#116
  def http_method; end

  # Returns the value of attribute key.
  #
  # source://oauth//lib/oauth/consumer.rb#80
  def key; end
  ...
  # source://oauth//lib/oauth/consumer.rb#392
  def proxy; end
  ...
  #
  # source://oauth//lib/oauth/consumer.rb#360
  def request_token_url; end

  # @return [Boolean]
  #
  # source://oauth//lib/oauth/consumer.rb#364
  def request_token_url?; end
  ...
  #
  # source://oauth//lib/oauth/consumer.rb#399
  def create_http(_url = T.unsafe(nil)); end

  # create the http request object for a given http_method and path
  #
  # source://oauth//lib/oauth/consumer.rb#451
  def create_http_request(http_method, path, *arguments); end

  # source://oauth//lib/oauth/consumer.rb#506
  def marshal_dump(*_args); end

  # source://oauth//lib/oauth/consumer.rb#510
  def marshal_load(data); end
end

# source://oauth//lib/oauth/consumer.rb#29
...
module OAuth::Helper
  ...
  # characters removed.
  #
  # source://oauth//lib/oauth/helper.rb#52
  def generate_key(size = T.unsafe(nil)); end

  # source://oauth//lib/oauth/helper.rb#56
  def generate_nonce(size = T.unsafe(nil)); end

  # source://oauth//lib/oauth/helper.rb#58
  ...
  #
  # source://oauth//lib/oauth/helper.rb#69
  ...
  #
  # source://oauth//lib/oauth/helper.rb#94
  ...
  #     #=>"1234567890"
  #
  # source://oauth//lib/oauth/helper.rb#117
  def parse_header(header); end

  # source://oauth//lib/oauth/helper.rb#135
  def stringify_keys(hash); end

  # source://oauth//lib/oauth/helper.rb#34
...
#
# source://oauth//lib/oauth/oauth.rb#22
...
#
# source://oauth//lib/oauth/oauth.rb#36
...
class OAuth::RequestProxy::Base
  ...
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#71
  def consumer_key; end

  # source://oauth//lib/oauth/request_proxy/base.rb#92
  def non_oauth_parameters; end

  # source://oauth//lib/oauth/request_proxy/base.rb#73
  def nonce; end

  # See 9.1.1. in specs Normalize Request Parameters
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#107
  def normalized_parameters; end

  # See 9.1.2 in specs
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#101
  ...
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#148
  def oauth_header(options = T.unsafe(nil)); end

  # source://oauth//lib/oauth/request_proxy/base.rb#33
  def oauth_nonce; end

  # source://oauth//lib/oauth/request_proxy/base.rb#88
  def oauth_parameters; end
  ...
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#62
  def oauth_verifier; end

  # source://oauth//lib/oauth/request_proxy/base.rb#66
  ...
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#80
  def parameters; end

  # source://oauth//lib/oauth/request_proxy/base.rb#84
  def parameters_for_signature; end

  # @return [Boolean]
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#155
  ...
  # source://oauth//lib/oauth/request_proxy/base.rb#111
  def sign(options = T.unsafe(nil)); end

  # source://oauth//lib/oauth/request_proxy/base.rb#115
  def sign!(options = T.unsafe(nil)); end

  # source://oauth//lib/oauth/request_proxy/base.rb#75
  def signature; end

  # source://oauth//lib/oauth/request_proxy/base.rb#96
  def signature_and_unsigned_parameters; end

  # See 9.1 in specs
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#122
  def signature_base_string; end

  # source://oauth//lib/oauth/request_proxy/base.rb#76
  ...
  # @return [Boolean]
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#128
  def signed?; end

  # URI, including OAuth parameters
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#133
  def signed_uri(with_oauth: T.unsafe(nil)); end

  # source://oauth//lib/oauth/request_proxy/base.rb#74
  def timestamp; end

  # source://oauth//lib/oauth/request_proxy/base.rb#72
  def token; end
  ...
  # source://oauth//lib/oauth/request_proxy/base.rb#165
  ...
  #
  # source://oauth//lib/oauth/request_proxy/base.rb#188
...
class OAuth::RequestToken < ::OAuth::ConsumerToken
  ...
  #
  # source://oauth//lib/oauth/tokens/request_token.rb#41
...
class OAuth::Signature::RSA::SHA1 < ::OAuth::Signature::Base
  ...
  # source://oauth//lib/oauth/signature/rsa/sha1.rb#40
  def decode_public_key; end

  # source://oauth//lib/oauth/signature/rsa/sha1.rb#49
  def digest; end
end
