...
module Shrine::Attachment::InstanceMethods
  ...
  #     Shrine::Attachment.new(:image).to_s #=> "#<Shrine::Attachment(image)>"
  #
  # source://shrine//lib/shrine/attachment.rb#55
  def to_s; end
end
...
module Shrine::ClassMethods
  ...
  #     end
  #
  # source://shrine//lib/shrine.rb#102
  def [](name, **args); end
  ...
  #     end
  #
  # source://shrine//lib/shrine.rb#101
  def attachment(name, **args); end
...
module Shrine::UploadedFile::InstanceMethods
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#68
  ...
  # storage and it has the same #id.
  #
  # source://shrine//lib/shrine/uploaded_file.rb#231
  def eql?(other); end
